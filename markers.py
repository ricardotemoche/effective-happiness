...
class FrameMarker(object):
    ...
    def setPose(self, pose):
        ...
        if (len(pose) == 7):
            ...
            q1 = np.matrix([[np.cos(np.pi/4.0)], [0.],
                           [0.], [np.sin(np.pi/4.0)]])
...
def quaternionMult(q1, q2):
    quat = 4*[0., ]
    quat[0] = -q1[1, 0]*q2[1, 0]-q1[2, 0] * \
        q2[2, 0]-q1[3, 0]*q2[3, 0]+q1[0, 0]*q2[0, 0]
    quat[1] = q1[0, 0]*q2[1, 0]-q1[3, 0] * \
        q2[2, 0]+q1[2, 0]*q2[3, 0]+q1[1, 0]*q2[0, 0]
    quat[2] = q1[3, 0]*q2[1, 0]+q1[0, 0] * \
        q2[2, 0]-q1[1, 0]*q2[3, 0]+q1[2, 0]*q2[0, 0]
    quat[3] = -q1[2, 0]*q2[1, 0]+q1[1, 0] * \
        q2[2, 0]+q1[0, 0]*q2[3, 0]+q1[3, 0]*q2[0, 0]
